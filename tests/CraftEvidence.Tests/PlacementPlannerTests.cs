...
public sealed class PlacementPlannerTests
{
  ...
  public void Plan_EmptyCase_StartsAtCaseAnchor()
  {
    ...
    Assert.AreEqual(3, result.StartRow);
    Assert.AreEqual(4, result.EndRow);
    Assert.AreEqual(new CellReference(3, 3), result.FocusCell);
  ...
  public void Plan_OldSide_FocusesPlacedImageTopLeftCell()
  {
    ...
    Assert.AreEqual(new CellReference(3, 18), result.FocusCell);
  }
