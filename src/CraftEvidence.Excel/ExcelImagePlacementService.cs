...
public sealed class ExcelImagePlacementService
{
  ...
  /// <summary>Deletes one verified CraftEvidence Shape by name for application-level Undo.</summary>
    ...
    string shapeName)
  {
    ...
    try
    {
      ...
      {
        return ImageDeletionResult.Failed("Undo対象のCraftEvidence画像が見つかりません。");
      }
